...
--
-- Overall schema hash: 24d91ae3629f5201966f1bdb54d8d919

-- Accepted on 2024-06-13T02:37:34.000Z by 20240613T023734.create_pingback_indices.ts
...
-- Index "idx_comments_pingbackPosts", hash 409ff38170f3b8c54bb4219aadd4fd21
...
-- Index "idx_comments_pingbackTags", hash a7910d64cadfebf5c4348dca47e2fb29
...
-- Index "idx_posts_pingbackTags", hash 4fc0ac2308940983e75b8cdd7e17fa5c
...
-- Table "Tags", hash 6b9453bfa01233459e8a6f9a3634bb95
CREATE TABLE "Tags" (
  _id VARCHAR(27) PRIMARY KEY,
  "name" TEXT NOT NULL,
  "shortName" TEXT,
...
-- Index "idx_tags_pingbackPosts", hash 77529d26c1e4d11b267d40cf25dc0a97
CREATE INDEX IF NOT EXISTS "idx_tags_pingbackPosts" ON "Tags" USING gin (("pingbacks" -> 'Posts'));

-- Index "idx_tags_pingbackTags", hash f41e825461685b0b06a1c2970c8c5b61
...
-- Table "Users", hash 836fe9c5426e68c2d2f2c3828c955134
CREATE TABLE "Users" (
  _id VARCHAR(27) PRIMARY KEY,
  "username" TEXT,
  "emails" JSONB[],
